...
import 'package:gecssmns/screens/reports/mpesa/this_month_chart.dart';
import 'package:gecssmns/screens/reports/mpesa/this_week_chart.dart';
import 'package:gecssmns/screens/reports/mpesa/this_year_chart.dart';
import 'package:gecssmns/screens/reports/mpesa/yearly_chart.dart';
import 'package:nb_utils/nb_utils.dart';

class ReportMpesaDashboard extends StatefulWidget {
  const ReportMpesaDashboard({super.key});

  @override
  State<ReportMpesaDashboard> createState() => _ReportMpesaDashboardState();
}

class _ReportMpesaDashboardState extends State<ReportMpesaDashboard> {
  @override
       ...
       Container(
        ...
        child: Column(children: [
          ...
          Container(
            ...
            color: Theme.of(context).secondaryBackground,
            child: Row(children: [
              const Text("MOBILE TRANSANCTIONS"),
              const Spacer(),
              TextButton.icon(
                onPressed: (){
                  snackBar(
              ...
              TextButton.icon(
                onPressed: (){
                  const DeskMpesaDashboard().launch(context);
                }, 
                icon:const Icon(Icons.panorama_fish_eye), 
                label: const Text('Mobile Transactions'),
                style: ButtonStyle(  
                  side: MaterialStateProperty.all(BorderSide(
                    color: Theme.of(context).btnBackground, // Set the desired border color
                    width: 1.0, // Set the desired border width
