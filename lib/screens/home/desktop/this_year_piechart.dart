...
class ThisYearPieChart extends StatefulWidget {
  const ThisYearPieChart({Key? key}) : super(key: key);

  @override
  State<ThisYearPieChart> createState() => _ThisYearPieChartState();
}

class _ThisYearPieChartState extends State<ThisYearPieChart> {
  ...
  void initState() {
   ...
   Future<void> fetchData() async {
    ...
    String url = '$baseur/v1/reports/overall_statistics_totals_year';
    setState(() {
      _isLoading = true;
    });
              ...
              children: [
                Expanded(
                  child: SfCircularChart(
                    tooltipBehavior:  _tooltipBehavior,
                    title: ChartTitle(text: 'This Year Overall Analysis', textStyle: GoogleFonts.teko()),
