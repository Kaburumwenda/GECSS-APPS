...
class ThisYearLineChart extends StatefulWidget {
  const ThisYearLineChart({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ThisYearLineChartState createState() => _ThisYearLineChartState();
}

class _ThisYearLineChartState extends State<ThisYearLineChart> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: _dataPoints.isNotEmpty
          ? SfCartesianChart(
            title: ChartTitle(text: 'This Year Analysis', textStyle: GoogleFonts.teko()),
            legend: const Legend(
