...
class MobileBatterySwaps extends StatefulWidget {
  const MobileBatterySwaps({super.key});

  @override
  State<MobileBatterySwaps> createState() => _MobileBatterySwapsState();
}

class _MobileBatterySwapsState extends State<MobileBatterySwaps> {
                ...
                child: DataTable(
                    ...
                    rows: List<DataRow>.generate(
                      ...
                      (index) => DataRow(cells: [
                        ...
                        DataCell(
                          SizedBox( width:40, child: Text( _data[index].amount.toString(), textAlign: TextAlign.center,),)),
                        DataCell(
                          Container(
                            width: 40.0,
