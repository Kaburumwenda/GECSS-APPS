...
class _RecordDeleteState extends State<RecordDelete> {
  ...
  _deleteRecord() async {
    if(mounted){
      ...
      String url = '$baseur/v1/battery/swap/soft_delete/${widget.recordData.id}';
        ...
        children: [
         ...
         Column(
           ...
           Row(
             ...
             children: [
             Text('Swap Center:', style: TextStyle(color: Theme.of(context).lightTextColor, fontSize: 14),),
             const SizedBox(width: 10,),
             Text(widget.recordData.source.toString(), style: TextStyle(
               color: Theme.of(context).headTextColor, 
               fontSize: 14,
               ))
           ],),
           Row(
             mainAxisAlignment: MainAxisAlignment.start,
             children: [
             Text('Battery Code:', style: TextStyle(color: Theme.of(context).lightTextColor, fontSize: 14),),
             const SizedBox(width: 10,),
             Text(widget.recordData.batteryCode1.toString(), style: TextStyle(
               color: Theme.of(context).headTextColor, 
               fontSize: 14,
               ))
           ],),
           Row(
             mainAxisAlignment: MainAxisAlignment.start,
             children: [
             Text('E-bike No:', style: TextStyle(color: Theme.of(context).lightTextColor, fontSize: 14),),
             const SizedBox(width: 10,),
             Text(widget.recordData.bikeNo.toString(), style: TextStyle(
               color: Theme.of(context).headTextColor, 
               fontSize: 14,
               ))
           ],),
